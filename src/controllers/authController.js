...
export const registerUser = async (req, res) => {
  ...
  // Викликаємо, передаємо об'єкт відповід та сесію
...
export const refreshUserSession = async (req, res) => {
  ...
  // Знаходимо поточнку сесію за id сесії та рефреш токеном
  ...
  // Якщо всі первірки пройшли, видаляємо поточну сесію
  await session.deleteOne();

  // Створюємо нову сесію і додаємо кукі
...
export const requestResetEmail = async (req, res) => {
  ...
  // Якщо користувача нема повертаємо Password reset email sent successfully.
  if (!user) {
